...
class User
{
    ...
    function registry($params)
    {
        ...
        $sql = "INSERT INTO users (name, surname, nickname, email, pass, registry_date, avatar, rol, last_connection, baneado, borrado) VALUES (";
        $sql .= "'" . $params['username'] . "', ";
        $sql .= "'" . $params['surname'] . "', ";
        $sql .= "'" . $params['nickname'] . "', ";
        $sql .= "'" . $params['email'] . "', ";
        $sql .= "'" . hash_hmac("sha512", $params['pass'], "jose") . "', ";
        $sql .= "'" . date("Y-m-d") . "', ";
