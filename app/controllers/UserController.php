        ...
        if (isset($_POST) && $_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if (count($errors) === 0) {
                ...
                if ($data['success']) {
                    ...
                    $data['message'] = "La edición se ha completado con éxito. Pulsa <a href='/foro/'>aquí</a> para volver al inicio.";
                } else {
    ...
    function registrer()
    {
        ...
        if (isset($_POST) && $_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if (count($errors) === 0) {
                ...
                if ($data['success']) {
                    prepareDataLogin($data['user']);
                    $data['message'] = "Su registro se ha completado con éxito. Pulsa <a href='/foro/'>aquí</a> para volver al inicio.";
                } else {
